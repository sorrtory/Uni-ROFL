...
Для доказательства не КС, нам достаточно выбрать слово, которое невозможно накачать для любого разбиения.

Возьмем длинное слово из языка, которое заканчивается на \3
...
Тогда все слова из $L$, оканчивающиеся на \3 не могут быть накачаны, значит такой подъязык не КС, значит и весь язык $L$ не КС.
