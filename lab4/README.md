...
Если доказывать более формальным путем, то если качать левую часть слова, то мы нарушим регулярку или строгую очередность возрастающих "a", разделенных строго b. Дубль мы не сможем накачать, так как он не палиндром (одного стека не хватит), не пересекается и может быть длины большей чем p.
