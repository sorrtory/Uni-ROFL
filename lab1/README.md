...
Таким образом все нормальные формы слова $aabc$ меньше самого слова $aabc$ в порядке $\succ_{\text{L}}$.

Важно также отметить, что проблемное правило $aabc \rightarrow bbaa$ не может применяться бесконечное число раз.

Действительно, из дерева разбора ясно что единственное место где мог бы возникнуть цикл в нашей системе переписывания &mdash; это слово $bccaaaa$ при условии того что перед ним стоит $aa$

Так как другие переписывания (в частности ветка $ccaabaa$) не приводят к тому, что появляются $bc$, которые могли бы привести к $aabc$.

Тогда только при условии что тратится $aa$ предшествующее начальному $aabc$ возникает новый цикл переписывания $aabc \rightarrow bbaa$, что увеличивает количество букв $b$.

Заметим, что для самого левого $bbaa$ из левой части слова нельзя будет брать $aa$ бесконечно для поддержания цикла, потому как правила 2,3 просто так не порождают новые $a$, а требуют и уменьшают $b$, которые рано или поздно закончатся.

Таким образом, правила 2,3 будут уменьшать количество $b$, правило 1 не может применяться бесконечно по причине конечного числа $aa$ в начале слова, а правило 4 уменьшает длину слова и не создает ни новых $a$, ни новых $b$.

Соответственно либо правила не могут применяться бесконечно, либо уменьшают порядок $\succ_{\text{L}}$, который бесконечно уменьшаться не может, а значит наша система завершается.
